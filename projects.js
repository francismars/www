const projects = [
  {
    name: "Chain Duel",
    type: "Lightning Game",
    description: "A Lightning-powered competitive game designed to gamify Bitcoin adoption. Players duel in real-time with instant microtransactions, demonstrating the speed and efficiency of Lightning payments. Featured at major Bitcoin conferences, the game showcases practical Lightning use cases while providing an engaging gaming experience.",
  ...
  },
  {
    name: "PubPay",
    type: "Nostr App",
    description: "A public payment client for Nostr. Create, share, and verify public payment requests using Nostr events. Supports donations, service payments, and more.",
